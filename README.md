...
- Set your Heroku app's buildpack URL to `https://github.com/striveanalytics/heroku-buildpack-nodejs-gulp.git`. To be safe, you should really fork this and use your fork's URL.
